  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="glass-card p-8 w-full max-w-md">
        <h2 className="text-3xl font-heading font-bold text-center mb-8">Welcome Back</h2>
        ...
        <p className="mt-6 text-center text-white/50 text-sm">
          Don't have an account? <Link to="/register" className="text-primary hover:text-white transition-colors">Register</Link>
        </p>
      </div>
    </div>
  );
